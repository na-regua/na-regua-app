...
export {default as CustomerJoinTodayQueueModal} from './CustomerJoinTodayQueueModal/CustomerJoinTodayQueueModal';
...
export {default as MuteNotificationsModal} from './MuteNotificationsModal/MuteNotificationsModal';
